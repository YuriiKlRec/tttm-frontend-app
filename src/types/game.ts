...
export interface Bet {
  ...
  price: string
  /**
   * Варіант відображення. `win` визначає лише корону (переможець) — колір
   * тексту/іконки керується окремим полем `mine`, щоб переможець, який НЕ є
   * поточним користувачем, не підсвічувався оранжевим (лишається лише корона).
   */
  variant: BetLineVariant
  /** Чи належить ставка поточному користувачу — визначає оранжевий колір тексту/іконки. */
  mine: boolean
