 ...
 * ціна (оранжева). Темний фон #212121 з оранжевою штриховою рамкою — єдиний
 * стиль плашки за макетом (сторінка гри й вкладка Waiting використовують той самий вигляд).
...
export const CurrencyPricePlate: FC<CurrencyPricePlateProps> = ({ price }) => (
  <div className="relative flex items-center justify-between border border-dashed border-[rgba(255,153,0,0.25)] bg-[#212121] px-4 py-1.5">
